...
for reg in regions:
    ...
    ax.set_xticks(list(category_dict_ct.keys()))
    ax.set_xticklabels(list(category_dict_ct.values()), rotation=30, ha='right')
    ax.legend()
